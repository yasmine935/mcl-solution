...
export class DashboardKia implements OnInit {
  ...
  loadReclamations() {
    ...
    // KIA voit les réclamations de ses techniciens (pas les siennes)
  ...
  loadFiches() {
    ...
    // KIA voit les fiches des techniciens (pas les siennes)
